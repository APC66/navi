...
@section('content')
  ...
  <x-heading level="h1" size="3xl" class="mb-6 flex items-center gap-6">
    <x-icon-radicle class="h-24 w-24" />
    <b>Welcome to Radicle</b>
  </x-heading>

  <p class="my-6">
    <x-button href="https://github.com/roots/radicle/tree/main/docs">Radicle Docs</x-button>
  </p>
  <p class="my-6">
    This route is used for demonstration purposes. It is registered from
    <code>routes/web.php</code>
    and the template is located at
  ...
  <div class="my-6 bg-gray-100 p-6">
    ...
    <pre
      class="mb-6"
    ><code class="language-blade">&lt;x-heading level="h1"&gt;Page Title&lt;/x-heading&gt;
...
&lt;x-heading level="h3"&gt;Subsection&lt;/x-heading&gt;</code></pre>
    ...
    <x-heading level="h4" size="lg" class="mt-8 mb-4">Links</x-heading>

    <pre
      class="mb-6"
    ><code class="language-blade">&lt;x-link href="/page"&gt;Default link&lt;/x-link&gt;
...
&lt;x-link href="https://example.com" external&gt;External link&lt;/x-link&gt;</code></pre>
    ...
    <x-heading level="h4" size="lg" class="mt-8 mb-4">Lists</x-heading>
...
&lt;/x-list&gt;</code></pre>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
      <div>
        <p class="mb-2 font-medium">Unordered List:</p>
      ...
      <div>
        <p class="mb-2 font-medium">Ordered List:</p>
  ...
  <p class="my-4">
    The
    <code>core/button</code>
    block is rendered with the
    <code>x-button</code>
    Blade component.
  </p>
  ...
  <div class="my-6 bg-gray-100 p-6">
    <pre
      class="mb-6"
    ><code class="language-blade">&lt;x-button href="#"&gt;Button&lt;/x-button&gt;</code></pre>
    <x-button href="#">Button</x-button>

    <pre
      class="my-6"
    ><code class="language-blade">&lt;x-button variant="outline" href="#"&gt;Outline Button&lt;/x-button&gt;</code></pre>
    <x-button variant="outline" href="#">Outline Button</x-button>

    <pre
      class="my-6"
    ><code class="language-blade">&lt;x-button variant="inverse" href="#"&gt;Inverse Button&lt;/x-button&gt;</code></pre>
    <div class="inline-block bg-black p-4">

...
@php
  $variantClasses = match ($variant) {
      "default" => $external ? "text-blue-600 hover:text-blue-800" : "text-blue-600 underline decoration-1 underline-offset-2 hover:text-blue-800 hover:decoration-2",
      "unstyled" => $external ? "text-inherit" : "text-inherit no-underline hover:underline",
      default => $external ? "text-blue-600 hover:text-blue-800" : "text-blue-600 underline decoration-1 underline-offset-2 hover:text-blue-800 hover:decoration-2",
  };

  $textClasses = $external
      ? match ($variant) {
  ...
  $classes = [$variantClasses, $weightClasses];
...
>
  ...
  @if ($external)
    ...
    <svg class="ml-0.5 inline size-3" fill="currentColor" viewBox="0 0 20 20">
      <path
        fill-rule="evenodd"

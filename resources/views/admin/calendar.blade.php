...
>
  ...
  >
    ...
    >
      <button
        class="button"
        onclick="document.getElementById('event-modal').style.display = 'none'"
      >
        Fermer
      </button>
      <a id="btn-boarding" href="#" class="button button-primary" target="_blank">
        📋 Liste Embarquement
      </a>
    ...
    >
      ...
      <textarea
        id="cancel-reason"
        placeholder="Raison (Météo, Panne...)"
      ...
      <div style="display: flex; gap: 10px; margin-top: 10px">
        <button
          ...
          style="background: #c53030; border-color: #c53030"
        >
